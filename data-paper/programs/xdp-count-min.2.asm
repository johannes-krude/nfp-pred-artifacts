 ...
 9f0:	.318  alu[gprA_6, --, B, gprB_12], gpr_wrboth
 9f8:	.319  alu[gprA_7, --, B, gprB_13], gpr_wrboth
 a00:	.320  alu[gprA_6, gprA_6, AND, gprB_4], gpr_wrboth
 a08:	.321  alu[gprA_7, gprA_7, AND, gprB_5], gpr_wrboth
 a10:	.322  dbl_shf[gprA_6, gprA_7, gprB_6, >>15], gpr_wrboth
 a18:	.323  alu_shf[gprA_7, --, B, gprB_7, >>15], gpr_wrboth
 a20:	.324  alu[*l$index0[1], --, B, gprB_6]
 a28:	.325  alu[gprA_6, --, B, *l$index0[1]], gpr_wrboth
 a30:	.326  alu[*l$index0[1], --, B, gprB_6]
 a38:	.327  immed[gprA_7, 0x0], gpr_wrboth
 a40:	.328  alu[gprA_6, --, B, *l$index0[1]], gpr_wrboth
 a48:	.329  immed[gprB_21, 0x3c6d]
 a50:	.330  immed_w1[gprB_21, 0x2c1b]
 a58:	.331  mul_step[gprA_6, gprB_21], start
 a60:	.332  mul_step[gprA_6, gprB_21], 32x32_step1
 a68:	.333  mul_step[gprA_6, gprB_21], 32x32_step2
 a70:	.334  mul_step[gprA_6, gprB_21], 32x32_step3
 a78:	.335  mul_step[gprA_6, gprB_21], 32x32_step4
 a80:	.336  mul_step[gprA_6, --], 32x32_last, gpr_wrboth
 a88:	.337  mul_step[gprA_7, --], 32x32_last2, gpr_wrboth
 a90:	.338  alu[gprA_6, gprA_6, AND, gprB_2], gpr_wrboth
 a98:	.339  alu[gprA_7, gprA_7, AND, gprB_3], gpr_wrboth
 aa0:	.340  dbl_shf[gprA_6, gprA_7, gprB_6, >>12], gpr_wrboth
 aa8:	.341  alu_shf[gprA_7, --, B, gprB_7, >>12], gpr_wrboth
 ab0:	.342  alu[*l$index0[1], --, B, gprB_6]
 ab8:	.343  alu[gprA_2, --, B, *l$index0[1]], gpr_wrboth
 ac0:	.344  alu[*l$index0[1], --, B, gprB_2]
 ac8:	.345  immed[gprA_3, 0x0], gpr_wrboth
 ad0:	.346  alu[gprA_2, --, B, *l$index0[1]], gpr_wrboth
 ad8:	.347  immed[gprB_21, 0x2d39]
 ae0:	.348  immed_w1[gprB_21, 0x297a]
 ae8:	.349  mul_step[gprA_2, gprB_21], start
 af0:	.350  mul_step[gprA_2, gprB_21], 32x32_step1
 af8:	.351  mul_step[gprA_2, gprB_21], 32x32_step2
 b00:	.352  mul_step[gprA_2, gprB_21], 32x32_step3
 b08:	.353  mul_step[gprA_2, gprB_21], 32x32_step4
 b10:	.354  mul_step[gprA_2, --], 32x32_last, gpr_wrboth
 b18:	.355  mul_step[gprA_3, --], 32x32_last2, gpr_wrboth
 b20:	.356  alu[gprA_6, --, B, gprB_2], gpr_wrboth
 b28:	.357  alu[gprA_7, --, B, gprB_3], gpr_wrboth
 b30:	.358  alu[gprA_6, gprA_6, AND, gprB_4], gpr_wrboth
 b38:	.359  alu[gprA_7, gprA_7, AND, gprB_5], gpr_wrboth
 b40:	.360  dbl_shf[gprA_6, gprA_7, gprB_6, >>15], gpr_wrboth
 b48:	.361  alu_shf[gprA_7, --, B, gprB_7, >>15], gpr_wrboth
 b50:	.362  immed[gprB_21, 0xffff007f, <<16]
 b58:	.363  alu[gprA_2, gprA_2, AND, gprB_21], gpr_wrboth
 b60:	.364  immed[gprA_3, 0x0], gpr_wrboth
 b68:	.365  alu[gprA_6, gprA_6, XOR, gprB_2], gpr_wrboth
 b70:	.366  alu[gprA_7, gprA_7, XOR, gprB_3], gpr_wrboth
 b78:	.367  alu[*l$index0, --, B, gprB_6]
 b80:	.368  alu[gprA_4, gprA_22, +, 0x8], gpr_wrboth
 b88:	.369  immed[gprA_5, 0x0], gpr_wrboth
 b90:	.370  alu[gprA_4, gprA_4, -, 0x8], gpr_wrboth
 b98:	.371  alu[gprA_5, gprA_5, -carry, 0x0], gpr_wrboth
 ba0:	.372  immed[gprA_2, 0x0], gpr_wrboth
 ba8:	.373  alu[gprA_3, --, B, gprA_2], gpr_wrboth
 bb0:	.374  alu[gprA_1, --, B, gprB_23], gpr_wrboth
 bb8:	.375  immed[gprA_21, 0xffff03ff, <<16]
 bc0:	.376  alu_shf[gprA_0, gprA_21, AND, *l$index0, <<2], gpr_wrboth
 bc8:	.377  alu[--, gprA_0, OR, gprB_1]
 bd0:	.378  beq[.384]
 bd8:	.379  immed[gprA_2, 0x1], gpr_wrboth
 be0:	.380  immed[gprA_3, 0x0], gpr_wrboth
 be8:	.381  immed[gprA_21, 0x890]
 bf0:	.382  ld_field[gprA_21, 1100, gprB_2, <<16]
 bf8:	.383  mem[add_imm, $xfer_0, gprB_1, <<8, gprA_0, 1], indirect_ref
 c00:	.384  immed[gprA_2, 0xffff, <<16], gpr_wrboth
 c08:	.385  immed[gprA_3, 0x0], gpr_wrboth
 c10:	.386  alu[gprA_12, gprA_12, AND, gprB_2], gpr_wrboth
 c18:	.387  alu[gprA_13, gprA_13, AND, gprB_3], gpr_wrboth
 c20:	.388  dbl_shf[gprA_12, gprA_13, gprB_12, >>16], gpr_wrboth
 c28:	.389  alu_shf[gprA_13, --, B, gprB_13, >>16], gpr_wrboth
 c30:	.390  alu[*l$index0[1], --, B, gprB_12]
 c38:	.391  alu[gprA_4, --, B, *l$index0[1]], gpr_wrboth
 c40:	.392  alu[*l$index0[1], --, B, gprB_4]
 c48:	.393  immed[gprA_5, 0x0], gpr_wrboth
 c50:	.394  alu[gprA_4, --, B, *l$index0[1]], gpr_wrboth
 c58:	.395  immed[gprB_21, 0x9f3b]
 c60:	.396  immed_w1[gprB_21, 0x45d]
 c68:	.397  mul_step[gprA_4, gprB_21], start
 c70:	.398  mul_step[gprA_4, gprB_21], 32x32_step1
 c78:	.399  mul_step[gprA_4, gprB_21], 32x32_step2
 c80:	.400  mul_step[gprA_4, gprB_21], 32x32_step3
 c88:	.401  mul_step[gprA_4, gprB_21], 32x32_step4
 c90:	.402  mul_step[gprA_4, --], 32x32_last, gpr_wrboth
 c98:	.403  mul_step[gprA_5, --], 32x32_last2, gpr_wrboth
 ca0:	.404  alu[gprA_4, gprA_4, AND, gprB_2], gpr_wrboth
 ca8:	.405  alu[gprA_5, gprA_5, AND, gprB_3], gpr_wrboth
 cb0:	.406  dbl_shf[gprA_4, gprA_5, gprB_4, >>16], gpr_wrboth
 cb8:	.407  alu_shf[gprA_5, --, B, gprB_5, >>16], gpr_wrboth
 cc0:	.408  alu[*l$index0[1], --, B, gprB_4]
 cc8:	.409  alu[gprA_4, --, B, *l$index0[1]], gpr_wrboth
 cd0:	.410  alu[*l$index0[1], --, B, gprB_4]
 cd8:	.411  immed[gprA_5, 0x0], gpr_wrboth
 ce0:	.412  alu[gprA_4, --, B, *l$index0[1]], gpr_wrboth
 ce8:	.413  immed[gprB_21, 0x9f3b]
 cf0:	.414  immed_w1[gprB_21, 0x45d]
 cf8:	.415  mul_step[gprA_4, gprB_21], start
 d00:	.416  mul_step[gprA_4, gprB_21], 32x32_step1
 d08:	.417  mul_step[gprA_4, gprB_21], 32x32_step2
 d10:	.418  mul_step[gprA_4, gprB_21], 32x32_step3
 d18:	.419  mul_step[gprA_4, gprB_21], 32x32_step4
 d20:	.420  mul_step[gprA_4, --], 32x32_last, gpr_wrboth
 d28:	.421  mul_step[gprA_5, --], 32x32_last2, gpr_wrboth
 d30:	.422  alu[gprA_6, --, B, gprB_4], gpr_wrboth
 d38:	.423  alu[gprA_7, --, B, gprB_5], gpr_wrboth
 d40:	.424  alu[gprA_6, gprA_6, AND, gprB_2], gpr_wrboth
 d48:	.425  alu[gprA_7, gprA_7, AND, gprB_3], gpr_wrboth
 d50:	.426  dbl_shf[gprA_6, gprA_7, gprB_6, >>16], gpr_wrboth
 d58:	.427  alu_shf[gprA_7, --, B, gprB_7, >>16], gpr_wrboth
 d60:	.428  immed[gprB_21, 0xffff007f, <<16]
 d68:	.429  alu[gprA_4, gprA_4, AND, gprB_21], gpr_wrboth
 d70:	.430  immed[gprA_5, 0x0], gpr_wrboth
 d78:	.431  alu[gprA_6, gprA_6, XOR, gprB_4], gpr_wrboth
 d80:	.432  alu[gprA_7, gprA_7, XOR, gprB_5], gpr_wrboth
 d88:	.433  alu[*l$index0, --, B, gprB_6]
 d90:	.434  alu[gprA_4, gprA_22, +, 0x8], gpr_wrboth
 d98:	.435  immed[gprA_5, 0x0], gpr_wrboth
 da0:	.436  alu[gprA_4, gprA_4, -, 0x8], gpr_wrboth
 da8:	.437  alu[gprA_5, gprA_5, -carry, 0x0], gpr_wrboth
 db0:	.438  immed[gprA_2, 0x0], gpr_wrboth
 db8:	.439  alu[gprA_3, --, B, gprA_2], gpr_wrboth
 dc0:	.440  alu[gprA_1, --, B, gprB_23], gpr_wrboth
 dc8:	.441  immed[gprA_21, 0xffff03ff, <<16]
 dd0:	.442  alu_shf[gprA_0, gprA_21, AND, *l$index0, <<2], gpr_wrboth
 dd8:	.443  alu[--, gprA_0, OR, gprB_1]
 de0:	.444  beq[.450]
 de8:	.445  immed[gprA_2, 0x1], gpr_wrboth
 df0:	.446  immed[gprA_3, 0x0], gpr_wrboth
 df8:	.447  immed[gprA_21, 0x890]
 e00:	.448  ld_field[gprA_21, 1100, gprB_2, <<16]
 e08:	.449  mem[add_imm, $xfer_0, gprB_1, <<8, gprA_0, 1], indirect_ref
 e10:	.450  immed[gprA_0, 0x1], gpr_wrboth
 e18:	.451  immed[gprA_1, 0x0], gpr_wrboth
 e20:	.452  br[.15000]
 e28:	.453  br[.15000], defer[2]
 e30:	.454  alu[gprA_0, --, B, 0x0]
 e38:	.455  ld_field[gprA_0, 1100, 0x82, <<16]
 e40:	.456  alu[--, 0x3, -, gprB_0]
 e48:	.457  bcc[.453]
 e50:	.458  immed[gprB_2, 0x2282]
 e58:	.459  immed_w1[gprB_2, 0x4411]
 e60:	.460  alu_shf[gprA_1, --, B, gprB_0, <<3]
 e68:	.461  alu[--, gprA_1, OR, 0x0]
 e70:	.462  alu_shf[gprB_2, 0xff, AND, gprB_2, >>indirect]
 e78:	.463  br[.15000], defer[2]
 e80:	.464  alu[gprA_0, --, B, 0x0]
 e88:	.465  ld_field[gprA_0, 1100, gprB_2, <<16]
 e90:	.466  nop
 e98:	.467  nop
 ea0:	.468  nop
 ea8:	.469  nop
