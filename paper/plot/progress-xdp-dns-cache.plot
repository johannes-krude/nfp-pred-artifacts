...
x2 = system('egrep -v " 0$" plot/progress-xdp-dns-cache.k.dat -m 1 | cut -d " " -f 1')
x2 = ceil(x2/10)*10
bm  = 0.375
gap = 0.05
...
plot \
'< egrep " 0$" plot/progress-xdp-dns-cache.k.dat; egrep -v " 0$" plot/progress-xdp-dns-cache.k.dat -m 1' using 1:($2/1000000000) axis x1y1 with steps ls 21 notitle, \
'< egrep -v " 0$" plot/progress-xdp-dns-cache.k.dat -m 1' using 1:($2/1000000000) axis x1y1 with points ls 21 pt 7 pointsize 0.25 notitle
...
#
#plot \
#'plot/progress-xdp-dns-cache.k.dat' using 1:($2/1000000000) axis x1y1 with steps ls 21 notitle
#
#unset multiplot
