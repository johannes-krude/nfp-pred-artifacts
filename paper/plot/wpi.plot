set terminal pdfcairo size 8.47415cm,3.2cm enhanced color fontscale 0.75 font 'Linux Libertine,10pt'
...
set key samplen 1 top left at 1,67000000 width 0.5
...
plot \
da+x*db ls 92 notitle, \
sa+x*sb ls 92 notitle, \
'plot/wpi-drop.dat' using 1:2 with linespoints ls 21 dt 2 title "Small Program", \
'plot/wpi-drop.dat' using 1:2:3:4 with errorbars ls 90 notitle, \
'plot/wpi-slow.dat' using 1:2 with linespoints ls 22 dt 2 title "Large Program", \
